...
# ------------------------------
df[["matchId", "passEventId", "becameShot", "startX", "startY", "endX", "endY",
    "log_dist_to_goal", "goal_angle", "shot_probability"]].to_csv(
    "passes_with_coordinates_features_and_prob.csv", index=False
)
print("\nSaved passes_with_coordinates_features_and_prob.csv")
