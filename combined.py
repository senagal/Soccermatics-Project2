...
Uses stored models to compute shot probability and xG.
"""
...
output_cols = [
    ...
    "becameShot","max_model_xG","shot_probability","pass_goal_probability"
]

df = df[output_cols]
df.to_csv("passes_with_goal_probabilities.csv", index=False)
print("Saved passes_with_goal_probabilities.csv with all passes and player info.")
